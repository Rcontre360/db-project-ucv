...
VALUES 
    ...
    ('X-Men: Days of Future Past', '2014-05-23', '20th Century Fox', 4, 'The X-Men send Wolverine to the past in a desperate effort to change history and prevent an event that results in doom for both humans and mutants.'),
...
VALUES 
    ...
    ('Bryan Singer', '131', '20th Century Fox', 'Superhéroe', 200000000, 747862775, 'X-Men: Days of Future Past'),
...
VALUES
    ...
    ('Groot', 'Avengers: Endgame', 'Vin Diesel', 'Secundario', 'Presta su voz'),
    ...
    ('Johann Shmidt', 'Avengers: Endgame', 'Hugo Weaving', 'Antagonista', 'Interpreta'),
    ('Loki Laufeyson', 'Avengers: Endgame', 'Tom Hiddleston', 'Antagonista', 'Interpreta'),
    ('Ultron', 'What If...?', 'James Spader', 'Antagonista', 'Presta su voz'),
    ('Victor Von Doom', 'X-Men: Days of Future Past', 'Julian McMahon', 'Secundario', 'Interpreta'),
    ('Erik Lehnsherr', 'X-Men: Days of Future Past', 'Ian McKellen', 'Secundario', 'Interpreta'),
    ('Pepper Potts', 'Avengers: Endgame', 'Gwyneth Paltrow', 'Secundario', 'Interpreta'),
    ('Jane Foster', 'Avengers: Endgame', 'Natalie Portman', 'Secundario', 'Interpreta'),
    ('May Parker', 'Spider-Man: Homecoming', 'Marisa Tomei', 'Secundario', 'Interpreta'),
    ('Gwen Stacy', 'Spider-Man: Into the Spider-Verse', 'Emma Stone', 'Secundario', 'Interpreta'),
    ('Betty Ross', 'What If...?', 'Liv Tyler', 'Secundario', 'Interpreta'),
    ('Nick Fury', 'Avengers: Endgame', 'Samuel L. Jackson', 'Secundario', 'Interpreta'),
    ('Reed Richards', 'What If...?', 'Ioan Gruffudd', 'Secundario', 'Presta su voz'),
    ('Charles Xavier', 'X-Men: Days of Future Past', 'Patrick Stewart', 'Secundario', 'Interpreta'),
    ('Emil Blonsky', 'What If...?', 'Tim Roth', 'Secundario', 'Interpreta'),
    ('Cain Marko', 'X-Men: Days of Future Past', 'Vinnie Jones', 'Secundario', 'Interpreta'),
    ('Thanos', 'Avengers: Endgame', 'Josh Brolin', 'Antagonista', 'Interpreta'),
    ('Norman Osborn', 'Spider-Man: Into the Spider-Verse', 'Willem Dafoe', 'Secundario', 'Presta su voz');
...
VALUES
    ...
    ('Loki Laufeyson', 'Magic', '2012-05-04', 'New York'),
    ('Ultron', 'Flight', '2015-05-01', 'Sokovia'),
    ('Victor Von Doom', 'Magic', '2023-04-01', 'New York'),
